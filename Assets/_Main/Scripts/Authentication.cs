...
/// <summary>
    ...
    public class Authentication : MonoBehaviour
    {
        ...
        private async void WalletConnect_SignAndLoginToMoralis(WalletConnectUnitySession session)
        {
            ...
            string signMessage = $"{Application.productName} requires your signature to authenticate.";
            ...
            Web3WalletData.Instance.SetPublicKey(address);
            var currentChainEntry = SupportedEvmChains.FromChainList(session.ChainId);
            Web3WalletData.Instance.SetChainEntry(currentChainEntry);
