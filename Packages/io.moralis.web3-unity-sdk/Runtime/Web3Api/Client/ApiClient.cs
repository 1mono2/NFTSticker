...
namespace MoralisUnity.Web3Api.Client
{
    ...
    public class ApiClient
    {
            ...
            Dictionary<String, FileParameter> fileParams, String[] authSettings)
        {
            ...
            if (queryParams.Count > 0)
            {
                ...
                foreach (var param in queryParams)
                {
                    ...
                    {
                        paramsAdded = true;
                        request.Path += $"?{param.Key}={UnityWebRequest.EscapeURL(param.Value)}";
                    }
                    else
                    {
                        request.Path += $"&{param.Key}={UnityWebRequest.EscapeURL(param.Value)}";
        ...
        public static string ParameterToHex(long val)
        {
        ...
        public static object Deserialize(string content, Type type, Dictionary<string, string> headers=null)
        {
